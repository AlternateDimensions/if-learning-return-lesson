...
public class Main {
    ...
    public static void main(String[] args) throws BadLocationException, FileNotFoundException {
        ...
        pages.add(new Page("IF/THEN Statements","public class Code {\n    public static void main(String[] args) {\n        int x = 5;\n        if (x == 5) {\n            System.out.println(\"Hello World!\");\n        }\n    }\n}","Output [~/Code.java/]\n-----------------------\nOUT | Hello World!",false,"An IF/THEN statememnt is a conditional statement. That means that a condition must be met in order for certain code to be ran! It asks the question:\n \"IF...THEN...\"\n\nIn the code editor, a simple IF statement has been written. The code checks to see if the int x has a value of 5. If it does, it will print \"Hello World!\". Since x is equal to 5, it meets the condition and does the within the IF/THEN statement. If x was not equal to 4, then the code inside of the IF/THEN statement would NOT have ran since the condition was not met.",false));
        ...
        pages.add(new Page("Demo End", "public class Code {\n    public static void main(String[] args) {\n        // You will be able to write code here!\n        System.out.println(\"...output goes here!\");\n    }\n}","Output [~/Code.java/]\n-----------------------\nOUT | ...output goes here!", false, "This is a temporary page for the end of the project. Unfortunately, I ran out of time to add more pages.", false));
